...
# Education
* 주전공: 전남대학교 통계학과 (2018.03 ~ 2024.02), 부전공: 소프트웨어공학과 (2020.03 ~ 2024.02)
...
<table align="center" style="margin-left: auto; margin-right: auto;">
  ...
  <tr>
    <td>Samsung Software Academy For Youth</td>
  ...
  <tr>
    <td valign="top">
      ...
      <table align="center" style="margin-left: auto; margin-right: auto;">
        ...
        <tr>
          <td>SSAFY 도메인 특화 프로젝트</td>
          <td>우수상</td>
        </tr>
        <tr>
          <td>디지털 신기술을 활용한 지역 문제해결 아이디어 공모전</td>
          <td>최우수상</td>
        </tr>
        <tr>
          <td>제 4회 오아시스 해커톤</td>
    ...
    <td valign="top">
      ...
      <table align="center" style="margin-left: auto; margin-right: auto;">
        ...
        <tr>
          <td>NCA(NAVER Cloud Platform Certified Associate)</td>
          <td>네이버클라우드플랫폼</td>
        </tr>
        <tr>
          <td>SQLD(SQL개발자)</td>
